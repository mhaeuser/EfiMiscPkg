  ...
  )
{
  ...
  } else if (NumberOfEnabledProcessors != NULL) {
    *NumberOfEnabledProcessors = NoEnabledProcessors;
  }
  ...
  )
{
  ...
  Status = mMpServices->GetProcessorInfo (This, ProcessorNumber, ProcessorInfoBuffer);
  ...
  )
{
  ...
  Status = mMpServices->WhoAmI (This, ProcessorNumber);
