  ...
  )
{
  ...
  ASSERT ((GcdMemoryType >= EfiGcdMemoryTypeNonExistent)
  ...
  )
{
  ...
  ASSERT ((GcdAllocateType >= EfiGcdAllocateAnySearchBottomUp)
  ...
  )
{
  ...
  ASSERT ((GcdIoType >= EfiGcdIoTypeNonExistent)
  ...
  )
{
  ...
  ASSERT (FirmwareVolumeHeader != NULL);
  ASSERT (Size > 0);
  ASSERT (FirmwareVolumeHandle != NULL);
  ASSERT (!EfiAtRuntime ());
